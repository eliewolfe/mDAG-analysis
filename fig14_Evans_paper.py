...
print("Fig 14b is not shown to have an IC Gap by any of the tricks=",as_classical_QmDAG(Fig_14b.as_mDAG).unique_unlabelled_id in set(qmdag.unique_unlabelled_id for qmdag in not_interesting_with_infeasible_supports))
