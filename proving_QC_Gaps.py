...
if __name__ == '__main__':
    ...
    known_QC_Gaps_mDAGs_id=[G_Instrumental.unique_unlabelled_id,G_Bell.unique_unlabelled_id,G_Triangle.unique_unlabelled_id]
    ...
    QG_Instrumental=QmDAG(DirectedStructure([(0,1),(1,2)],3),Hypergraph([],3),Hypergraph([(1,2)],3))
