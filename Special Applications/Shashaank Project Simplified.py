...
print(f"Sanity check, 7 hard graphs still unresolved:", the_7_hard_ids.issubset(m.unique_unlabelled_id for m in unresolved_by_reduction_or_Shaashank_or_CI_or_HLP))
