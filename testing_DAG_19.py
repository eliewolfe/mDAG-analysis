...
print("Attempt to prove interestingness of this remaining one using TC's algorithm with cardinalities 6222:")
interesting=False
n=2
while n<11 and interesting==False:    #11 is a big number of events choosen randomly, just so it doesn't run forever
    if not G_19.no_infeasible_6222_supports_beyond_dsep_up_to(n):
        ...
        print("is still not shown interesting by TC's algorithm (cardinality 6222) up to",n,"events.")
        n=n+1
